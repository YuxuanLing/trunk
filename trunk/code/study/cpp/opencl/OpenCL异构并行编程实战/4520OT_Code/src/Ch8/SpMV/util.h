                ...
                int **rowDelimiters_ptr, int *n, int *size) 
{
    ...
    *n = nElements; 
    *size = nRows; 
    *val_ptr = new floatType[nElements]; 
    *cols_ptr = new int[nElements];
    *rowDelimiters_ptr = new int[nRows+1]; 
                     ...
                     int *newSize) 
{
    ...
    *newA_ptr = new floatType[paddedSize];
    *newcols_ptr = new int[paddedSize]; 
