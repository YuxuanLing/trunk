...
e.g. In the sources provided, navigate to "Ch2/sub_buffers" and run the command 

> /opt/AMDAPP/tools/AMDAPPProfiler-2.5/x86_64/sprofile -o perf.log -k all ./sub_buffer
