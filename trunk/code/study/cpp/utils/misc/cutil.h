/**********************************************************************************************************************
*	$Log: vsys#comm#inc#cutil.h_1,v $
*	Revision 1.10  2007-09-20 00:12:15-07  lsha
*	Fix xdbg & _fLOG
*
*	Revision 1.9  2007-08-27 18:50:53-07  lsha
*	Re-partition include files
*
*
*	DESCRIPTION:
*	Suggested to be included by all non-embedded C/C++ files.
*	It includes macros and function declarations of useful utilities.
*
*	Implementation C/C++ files:
*		- "../_util/api.c"
*		- "../_util/cfg.c"
*
**********************************************************************************************************************/
 ...
 */
	extern	UNSG32	  garru32[KILO];
	extern	SIGN32	 *garrs32;
	extern	char	 *garrs8;
	extern	UNSG32	**garrpu32;
	extern	SIGN32	**garrps32;
	extern	char	**garrps8;

	extern	void	*_dbgCFG;
	extern	UNSG32	dbghfp, dbgmask;

	/* Usage: _dftLOG(bLogFlush, item_bit, ("item = %d\n", item_value)) */
	#define	_dftLOG(flush, b, fmt_args)	do{	_LOG(dbghfp, dbgmask, b, fmt_args); if(flush) _dflush(dbghfp); }while(0)
...
/**	SECTION - common memory functions in "../_util/api.c"
 */
	/******************************************************************************************************************
